  ...
  class OddballzApp {
    ...
    initEventListeners() {
      const closeModal = () => {
        ...
        if (this.wasPausedByModal && this.isPlaying && this.isPaused) {
          this.wasPausedByModal = false;
          this.togglePause();
        }
      };
      ...
      if (btnHighScores) btnHighScores.addEventListener('click', () => this.showHighScoresModal());

      const btnOverlayHighScores = document.getElementById('btnOverlayHighScores');
      if (btnOverlayHighScores) btnOverlayHighScores.addEventListener('click', () => this.showHighScoresModal());
    ...
    showHighScoresModal() {
      ...
      if (this.highScores.length === 0) {
        tbody.innerHTML = '<tr><td colspan="4" style="text-align:center; color:var(--text-muted);">No high scores yet!</td></tr>';
      } else {
